...
// shorter than k. It is guaranteed that there are no consecutive dashes in s.
//
//Example
//
...
//
//The input string "2-4a0r7-4k" is split into three groups with lengths of
// 1, 5 and 2. Since k = 4, you need to split the string into two groups of 4
// characters each, making the output string "24a0-r74k".
//
